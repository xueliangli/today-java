...
![icon](img/14_img01.png)

2. 演示事务

![icon](img/14_img02.png)
...
1. 设置A窗口的隔离级别为 读未提交 
![icon](img/14_img03.png)

2. 两个窗口都分别开启事务

![icon](img/14_img04.png)
...
![icon](img/14_img09.png)

* 乐观锁

> 要求程序员自己控制。 

![icon](img/14_img10.png)
